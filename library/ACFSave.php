 ...
 *
 */
add_action('admin_head-post.php', 'famelo_acf_export');
function famelo_acf_export() {
	global $acf;
...
$output = __('<?php
	...
	if (is_writable($file)) {
		...
		add_action('admin_notices', 'famelo_acf_export_success');
	}  else {
		add_action('admin_notices', 'famelo_acf_export_fail');
	}
}
 ...
 */
function famelo_acf_export_success( $file = '' ) {
 ...
 */
function famelo_acf_export_fail( $file = '' ) {
